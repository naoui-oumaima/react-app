    ...
    <div>
      <div className="row">
          ...
          <div className="col d-grid gap-2 d-md-flex justify-content-md-end">
              <bouton className="btn btn-success day" onClick={()=>updateData('day')}>Today</bouton>
              <div className="weekbtn">
                  <bouton className="btn" onClick={()=>updateData('six_weeks')} >6Weeks</bouton>
              </div>
              <div className="yearbtn">
                  <bouton className="btn" onClick={()=>updateData('one_year')} >1year</bouton>
              </div>
          </div>
      </div>
